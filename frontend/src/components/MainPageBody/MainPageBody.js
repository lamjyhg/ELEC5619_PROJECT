...
const MainLayout = () => {
    ...
    return(
        ...
        <div className="main_container">
            ...
            <div className="large_title_section">
                ...
                <div className="review_container">
                    ...
                    <div className="single_review">
                        ...
                        <div className="comment">
                            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in faucibus lorem. Phasellus rhoncus interdum pellentesque.
                            Nullam consectetur velit faucibus risus bibendum m"
                        </div>
