...
import {handleActionToApproveApplication, handleActionToDisapproveApplication} from "../../state/gyms/gyms.action";
    ...
    return (
      <Layout>
          <Row align={"center"}>
              ...
              <Col className="gutter-row" span={2}>
                  <Button type="primary" onClick={() => handleDisapprove()}>Disapprove</Button>
              </Col>
              <Col className="gutter-row" span={2} >
                  <Button type="primary" onClick={() => navigate("/admin/gymRequests")}>Cancel</Button>
              </Col>
          </Row>
