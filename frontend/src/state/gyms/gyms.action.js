...
import {
  ...
  handleRequestToGetGymTimeAvailability,
...
export const handleActionToGetGymTimeAvailability = createAsyncThunk(
  'GET_GYM_TIME_AVAILABILITY_BY_START_AND_END',
  async (params, thunkAPI) => {
    try {
      return await handleRequestToGetGymTimeAvailability(
        params.id,
        params.body
      );
    } catch (error) {
